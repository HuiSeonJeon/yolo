def get_detected_img(cv_net, img_array, conf_threshold, nms_threshold, use_copied_array = True, is_print=True):
    ...
    # cv_net_yolo.getUnconnectedOutLayers()의 반환 결과 = 1차원 형태 layer id
...
def do_detected_video(cv_net, input_path, output_path, conf_threshold, is_print):
    ...
    while True:
        ...
        draw_img = get_detected_img(cv_net_yolo, img_frame, conf_threshold=conf_threshold, nms_threshold=nms_threshold, use_copied_array=False, is_print=True)
...
do_detected_video(cv_net_yolo, './data/2k_30s.mp4', './data/2k_30s_02.mp4', 0.2, False)
